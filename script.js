...
var state = {
    ...
    maxNumOfRender: 10, //how many recipe to render to DOM
    rawData: [],
    recipes: [],
    likes: [],
    currentModal: null,
...
$('document').ready(function () {
    ...
    function renderRecipe(obj, i = 0) {
        ...
        renderIngredients('.ingredients--used', obj.usedIngredients);
        renderIngredients('.ingredients--missed', obj.missedIngredients);
        
        // Add all recipe data to recipe DOM(using data attr)
        addDataToRecipe(obj);
    }
    function renderIngredients(addTo, arr) {
